...
public class RedisTopic implements Topic {
     ...
     */
    public RedisTopic(String topicName){
        this.name = topicName;
     ...
     */
    public RedisTopic(String topicName, RedisRepository repository){
        this.name = topicName;
    ...
    public void subscribe(Consumer consumer) {
        this.getRepository().getController().sadd(RedisTopicUtils.getConsumersKey(this.name()), consumer.name());
    }
    ...
    public void unsubscribe(Consumer consumer) {
        this.getRepository().getController().srem(RedisTopicUtils.getConsumersKey(this.name()), consumer.name());
    }
    ...
    public List<Consumer> consumers() {
        ...
        String topicKey = RedisTopicUtils.getConsumersKey(this.name());
