...
public interface MessageRepository {
     ...
     */
    List<Message> getAllNotConsumedMessagesByTopic(String topic) throws IllegalArgumentException;
    ...
    void addMessageToTopic(String name, Message message);

    Message getMessageFromTopic(String topicName);
}
